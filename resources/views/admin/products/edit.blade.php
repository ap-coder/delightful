    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_title') ? 'is-invalid' : '' }}" type="text" name="facebook_title" id="facebook_title" value="{{ old('facebook_title', $product->facebook_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('seo_description') ? 'is-invalid' : '' }}" name="seo_description" id="seo_description">{{ old('seo_description', $product->seo_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_size') ? 'is-invalid' : '' }}" name="product_size_id" id="product_size_id">
                    @foreach($product_sizes as $id => $product_size)
                        <option value="{{ $id }}" {{ ($product->product_size ? $product->product_size->id : old('product_size_id')) == $id ? 'selected' : '' }}>{{ $product_size }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_color') ? 'is-invalid' : '' }}" name="product_color_id" id="product_color_id">
                    @foreach($product_colors as $id => $product_color)
                        <option value="{{ $id }}" {{ ($product->product_color ? $product->product_color->id : old('product_color_id')) == $id ? 'selected' : '' }}>{{ $product_color }}</option>
                    @endforeach
                </select>
