        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.contentPage.fields.page_sections') }}
                        </th>
                        <td>
                            @foreach($contentPage->page_sections as $key => $page_sections)
                                <span class="label label-info">{{ $page_sections->section_nickname }}</span>
                            @endforeach
                        </td>
                    </tr>
                    <tr>
