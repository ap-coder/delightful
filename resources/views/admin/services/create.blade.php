    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.services.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', '100.00') }}" step="0.01">
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icon_class') ? 'is-invalid' : '' }}" type="text" name="icon_class" id="icon_class" value="{{ old('icon_class', 'fa-cog') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube_video') ? 'is-invalid' : '' }}" type="text" name="youtube_video" id="youtube_video" value="{{ old('youtube_video', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter_desc') ? 'is-invalid' : '' }}" type="text" name="twitter_desc" id="twitter_desc" value="{{ old('twitter_desc', '') }}">
