    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_name') ? 'is-invalid' : '' }}" type="text" name="seo_name" id="seo_name" value="{{ old('seo_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_desc') ? 'is-invalid' : '' }}" type="text" name="seo_desc" id="seo_desc" value="{{ old('seo_desc', '') }}">
