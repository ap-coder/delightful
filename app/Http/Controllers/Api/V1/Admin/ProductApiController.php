...
class ProductApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ProductResource(Product::with(['categories', 'tags', 'product_size', 'product_color'])->get());
    }
    ...
    public function show(Product $product)
    {
        ...
        return new ProductResource($product->load(['categories', 'tags', 'product_size', 'product_color']));
    }
